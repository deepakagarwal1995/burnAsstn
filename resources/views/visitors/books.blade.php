                        ...
                        @foreach ($items as $row)
                            <div class="col-lg-6 col-md-6 col-sm-12 event-block">
                                <div class="event-block-one">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            <figure class="image"><a href="#0"><img
                                                        src="{{ url('storage/images/' . $row->image) }}" alt=""></a>
                                            </figure>

                                        </div>
                                        <div class="lower-content">
                                            <div class="text-box">
                                                <h3><a href="#0">{{ $row->title }}</a>
                                                </h3>
                                                <p>{{ $row->sdescr }}</p>
                                                <ul class="info-list clearfix">
                                                    ...
                                                    <li> <a
                                                         ...
                                                         href="{{route('view_resource',$row->id)}}" class="header-btn"
                                                         @else
                                                         href="#exampleModal" data-bs-toggle="modal" data-bs-target="#exampleModal" class="open-AddBookDialog header-btn" data-id="{{$row->id}}"
                                                         @endif
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Please Provide Some Basic Details
                                <br><p class="m-0">Before Accessing Resources</p></h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                 <form method="post" action="{{route('submitBasic')}}"
                                    >
                                    @csrf
                                    <div class="row clearfix">
                                        <input name="type" type="hidden" required="" value="Resourse View">
                                        <input name="id" type="hidden" required="" value="" class="rid">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <select name="code" class="selectmenu" style="width:25%">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
                                            <button class="theme-btn btn-one mt-3 w-100" type="submit" name="submit-form">Submit
                                                Now</button>
                                        </div>
                                    </div>
                                </form>
