@extends('layouts.visitorsApp', ['page_title' => 'Registration'])
@section('content')
    ...
    <section class="join-volunteer-section">
        <div class="auto-container">
                    ...
                    <div class="donation-inner">
                        <div class="tabs-box">
                            ...
                            <div class="form-inner">
                                <form method="post" action="{{route('submitRegistration')}}" class="default-form"
                                    >
                                    @csrf
                                    <div class="row clearfix">
                                        <div class="col-lg-6 col-md-12 col-sm-12 form-group">
                                            ...
                                            <div class="select-box">
                                                <select name="title" class="selectmenu" required>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12 form-group">
                                            ...
                                            <input name="mname" type="text" required="" class="form-control">
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-sm-12 form-group">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12 form-group">
                                            <label>Highest academic qualification<span class="text-danger">*</span></label>
                                            <input name="qualification" type="text" required="" class="form-control">
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-sm-12 form-group">
                                            <label>Affiliation / Institute<span class="text-danger">*</span></label>
                                            <input name="institute" type="text" required="" class="form-control">
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-sm-12 form-group">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                            <label>Details of national association & membership number<span
                                                    class="text-danger">*</span></label>
                                            <input name="details" type="text" required="" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <select class="selectmenu" name="code" style="width:25%">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
                                            <button class="theme-btn btn-one" type="submit" name="submit-form">Register
                                                Now</button>
                                        </div>
                                    </div>
                                </form>
